...
Object Detection and Classification on 2-Digit MNIST Dataset. As you can see in results.png, the currently trained model (ckpt) classifys both digits correctly 96% of the time with an iou on the predicted bounding boxes of 0.91. The compressed dataset is located in the data folder. To train a new model, change train=True on line 8 of main.py.
